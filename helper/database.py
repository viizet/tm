...
DB_NAME = os.environ.get("DB_NAME", "kevyabdi1")
DB_URL = os.environ.get("DB_URL", "mongodb+srv://<db_username>:<db_password>@kevyabdi.nadl4mg.mongodb.net/?retryWrites=true&w=majority&appName=kevyabdi")
